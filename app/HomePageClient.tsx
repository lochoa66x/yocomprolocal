...
const content = {
  es: {
    ...
    featuredText:
      "Estos productos vienen directo de vendedores de YoComproLocal y están listos para contactar por WhatsApp.",
    featuredCta: "Ver todos los productos",
    featuredEmpty:
      "Cuando haya productos publicados, aparecerán aquí para que la página principal se sienta viva.",
    featuredProductLink: "Ver producto",
    featuredWhatsapp: "Preguntar por WhatsApp",
    product: {
